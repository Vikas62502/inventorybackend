...
- [ ] Frontend can display complete address from GET /customers
- [ ] Frontend can edit all address fields via PUT /customers/{id}
- [ ] Frontend receives consistent address structure across all endpoints
- [ ] Address editing form works correctly
